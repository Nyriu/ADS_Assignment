...
genres_playtime %>%
  ...
  #geom_bar(aes(y=-(playtime_rel*playtime_rel)/7), stat="identity", fill=alpha("red", 0.5)) + # TODO transition
...
Come è variata la popolarità dei generi negli anni? (bel grafico animato)
